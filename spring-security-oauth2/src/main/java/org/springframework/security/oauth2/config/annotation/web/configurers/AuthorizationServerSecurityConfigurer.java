...
public final class AuthorizationServerSecurityConfigurer extends
    ...
    public AuthorizationServerSecurityConfigurer basicAuthenticationEntryPoint(AuthenticationEntryPoint basicAuthenticationEntryPoint) {
    ...
    public void init(HttpSecurity http) throws Exception {
        ...
        HttpBasicConfigurer<HttpSecurity> httpBasicConfigurer = http.securityContext()
                .securityContextRepository(new NullSecurityContextRepository()).and().csrf().disable().httpBasic()
                .realmName(realm);
        if (basicAuthenticationEntryPoint != null) {
            httpBasicConfigurer.authenticationEntryPoint(basicAuthenticationEntryPoint);
        }
        if (sslOnly) {
